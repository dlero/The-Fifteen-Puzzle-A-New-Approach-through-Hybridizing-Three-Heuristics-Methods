...
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {3, 7, 2, 5}, {4, 8, 6, 1}};
//        int[][] temp = {{0, 12, 10, 13}, {15, 11, 14, 9}, {3, 7, 2, 5}, {4, 8, 6, 1}};
//        int[][] temp = {{0, 11, 9, 13}, {12, 15, 10, 14}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 15, 9, 13}, {11, 12, 10, 14}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 12, 14, 13}, {15, 11, 9, 10}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 12, 10, 13}, {15, 11, 14, 9}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 12, 11, 13}, {15, 14, 10, 9}, {3, 7, 6, 2}, {4, 8, 5, 1}};
//        int[][] temp = {{0, 12, 10, 13}, {15, 11, 9, 14}, {7, 3, 6, 2}, {4, 8, 5, 1}};

//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 14, 10}, {3, 8, 6, 2}, {4, 7, 5, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {8, 3, 6, 2}, {4, 7, 5, 1}};
//        int[][] temp = {{0, 12, 14, 13}, {15, 11, 9, 10}, {8, 3, 6, 2}, {4, 7, 5, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {7, 8, 6, 2}, {4, 3, 5, 1}};
//        int[][] temp = {{0, 12, 10, 13}, {15, 11, 14, 9}, {7, 8, 6, 2}, {4, 3, 5, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 8, 10, 14}, {11, 7, 6, 2}, {4, 3, 5, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {3, 7, 5, 6}, {4, 8, 2, 1}};
//        int[][] temp = {{0, 12, 9, 13}, {15, 11, 10, 14}, {7, 8, 5, 6}, {4, 3, 2, 1}};

//--------------The 11 configurations that require 80 moves have the blank tile located at the top-left corner.--------------
//        int[][] temp = {{15, 14, 8, 12}, {10, 11, 9, 13}, {2, 6, 5, 1}, {3, 7, 4, 0}};
//        int[][] temp = {{15, 11, 13, 12}, {14, 10, 8, 9}, {7, 2, 5, 1}, {3, 6, 4, 0}};
//        int[][] temp = {{15, 11, 13, 12}, {14, 10, 8, 9}, {2, 6, 5, 1}, {3, 7, 4, 0}}; 
//        int[][] temp = {{15, 11, 9, 12}, {14, 10, 13, 8}, {6, 7, 5, 1}, {3, 2, 4, 0}}; 
//        int[][] temp = {{15, 11, 9, 12}, {14, 10, 13, 8}, {2, 6, 5, 1}, {3, 7, 4, 0}}; 
//        int[][] temp = {{15, 11, 8, 12}, {14, 10, 13, 9}, {2, 7, 5, 1}, {3, 6, 4, 0}};
//        int[][] temp = {{15, 11, 9, 12}, {14, 10, 8, 13}, {6, 2, 5, 1}, {3, 7, 4, 0}};
//        int[][] temp = {{15, 11, 8, 12}, {14, 10, 9, 13}, {2, 6, 5, 1}, {3, 7, 4, 0}};
//        int[][] temp = {{15, 11, 8, 12}, {14, 10, 9, 13}, {2, 6, 4, 5}, {3, 7, 1, 0}};
//        int[][] temp = {{15, 14, 13, 12}, {10, 11, 8, 9}, {2, 6, 5, 1}, {3, 7, 4, 0}};
//        int[][] temp = {{15, 11, 13, 12}, {14, 10, 9, 5}, {2, 6, 8, 1}, {3, 7, 4, 0}};


        //------------------------------------100 Instances Korf ---------------------------
        int[][] temp={{14,13,15,7},{11,12,9,5},{6,0,2,1},{4,8,10,3}}; //57
...
//        int[][] temp = {{4, 7, 14, 13}, {10, 3, 9, 12}, {11, 5, 6, 15}, {1, 2, 8, 0}}; //56
